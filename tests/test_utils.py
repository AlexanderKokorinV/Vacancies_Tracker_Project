...
def test_create_database_success(test_db_config):
...
def test_create_database_recreation(test_db_config):
...
def test_save_to_db(db_connection, manager):
    ...
    with db_connection.cursor() as cur:
        ...
        assert cur.fetchone()[0] == "Super Company"
...
def test_save_to_db_none_salary(db_connection, manager):
